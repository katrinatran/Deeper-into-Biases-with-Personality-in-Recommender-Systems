...
@author: making changes for project = Katrina
        - commented out parts of trained test --> that part was moved to main.py to do calculations
            for evaluating with the model and fit together with the project
"""
...
def train_test(model, train_data, test_data):
    ...
    #     # sub_scores = scores.topk(20)[1] --> used to be 20
